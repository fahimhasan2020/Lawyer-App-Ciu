...
export class TrackLive extends Component {
    state={
        location:null
    }
    ...
    render() {
        return (
            <View style={{margin:10,padding:10,backgroundColor:'#FFF',elevation:10}}>
                <Text style={{marginBottom:20,fontWeight:'bold',color:'#CCC'}}> Your Live Location </Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(TrackLive)
